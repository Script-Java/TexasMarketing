...
const Navbar = () => {
    return (
      <div className="">
        <header className="sticky pt-4 pb-4 top-4 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
          <nav
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center text-white text-xl">
                <img className="w-12 l-10" src={logo} alt="" />
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-end py-2 md:py-0 md:ps-7">
                ...
                <div>
                  <a
                    className="group inline-flex items-center gap-x-2 py-2 px-3 bg-blue-500 text-white font-medium text-sm text-neutral-800 rounded-full focus:outline-none"
